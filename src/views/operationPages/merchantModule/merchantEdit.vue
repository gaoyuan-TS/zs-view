<template>
  <div class="merchantedit">
    <page-content name="Merchant editor">
      <div class="content">
        ...
        <div class="content-item">
          ...
          <!-- 营业执照或是身份证、护照 -->
          <div class="upload-item" v-if="enterprise === '企业'">
          ...
          <!-- 商家类型为个人： 身份证 -->
          <div class="upload-item" v-if="enterprise === '非企业'">
            <div class="upload-item-title">身份证正面：</div>
            <div>
              <el-upload
                class="avatar-uploader"
                action="https://zs.cntracechain.com/imageService/image/add"
          ...
          <div class="upload-item" v-if="Number(enterprise) === 2">
            <div class="upload-item-title">身份证反面：</div>
            <div>
              <el-upload
                class="avatar-uploader"
                action="https://zs.cntracechain.com/imageService/image/add"
  ...
  methods: {
    ...
    getMerchantDetail() {
      this.$get('/back-end/merchant/get?merchantId=' + this.merchantId).then(res => {
        ...
        this.sfzBImg = res.data.papersBackUrl
        // 商家图片
