<template>
  <div class="tracesumptiondetail">
    <page-content :name="$t('topUp.consumPtionD.traceConsumDetailsTitle')">
      <div class="content">
          ...
          <el-col :span="24">
            <div class="list">
              <el-table :data="tableData" style="width: 100%" height="500" stripe>
                <el-table-column prop="date" :label="$t('topUp.consumPtionD.date')"></el-table-column>
                <el-table-column prop="scanCount" :label="$t('topUp.consumPtionD.dayScanCode')"></el-table-column>
                <el-table-column prop="deductIntegral" :label="$t('topUp.consumPtionD.dayIntegral')"></el-table-column>
              </el-table>
            </div>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    getQueryCodeTraceLog() {
      ...
      this.$post('/management_point/integralLog/queryCodeTraceLog', _params).then(res => {
