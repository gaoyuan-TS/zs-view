    ...
    <page-content name="新建生产批次">
      <div class="content">
        ...
        <div v-for="(sceItem, sceIdx) in scenarioList" :key="sceIdx">
          ...
          <!-- 场景信息 -->
          <el-row style="margin-top: 25px; color: #333333;font-weight: 500">
            <el-col :span="6">
          ...
          <div v-for="(maItem, maIdx) in sceItem.materialList" :key="maIdx">
            <el-row type="flex" justify="space-between" style="margin-top: 40px">
              ...
              <el-col :span="6">
                <div class="item-input">
                  <el-input v-model="maItem.outStorageCount" placeholder="数量" style="flex:1"></el-input>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="item-input">
            ...
            <el-row style="margin-top: 30px" v-if="materialDetail[sceIdx]">
              <el-col :span="6">
                <div class="item-input" style="font-size: 16px">
                  原材料名称：{{materialDetail[sceIdx].name}}
                </div>
              </el-col>
              <el-col :span="6">
                <div class="item-input" style="font-size: 16px">
                  入库时间：{{materialDetail[sceIdx].createTime}}
                </div>
              </el-col>
              <el-col :span="6">
                <div class="item-input" style="font-size: 16px">
                  库房编号：{{materialDetail[sceIdx].warehouseNumber}}
                </div>
              </el-col>
              <el-col :span="6">
                <div class="item-input" style="font-size: 16px">
                  原材料供应商：{{materialDetail[sceIdx].supplier}}
                </div>
              </el-col>
            </el-row>

            <el-row v-if="materialDetail[sceIdx]">
              <el-col>
                <div class="item-input" style="font-size: 16px">
                  货物剩余数量：{{materialDetail[sceIdx].residueStock}}{{materialDetail[sceIdx].unit}}
                </div>
              </el-col>
            </el-row>
          </div>
