      ...
      <div class="content">
        <div class="content-item">
          ...
          <div class="content-item-item">
            ...
            <div class="item-input" style="width: 80%">
              <el-input v-model="merchantAccount"></el-input>
            </div>
          </div>
          <!-- 是否企业 -->
          <div class="content-item-item">
          ...
          <!-- 法人代表 -->
          <div class="content-item-item">
            <div class="item-title" v-if="Number(enterprise) === 1">{{$t('merchant.merchantRepre')}}</div>
            <div class="item-title" v-if="Number(enterprise) === 2">身份证姓名</div>
            <div class="item-input" style="width: 80%">
        ...
        <div class="content-item">
          ...
          <div class="upload-item" v-if="Number(enterprise) === 2">
            <div class="upload-item-title">{{$t('merchant.IDCard')}}：</div>
            <div>
              <el-upload
                class="avatar-uploader"
                action="https://zs.cntracechain.com/imageService/image/add"
          ...
          <div class="upload-item" v-if="Number(enterprise) === 2">
            <div class="upload-item-title">{{$t('merchant.IDCardReverse')}}：</div>
            <div>
              <el-upload
                class="avatar-uploader"
                action="https://zs.cntracechain.com/imageService/image/add"
